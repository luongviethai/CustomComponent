		...
		<>
			...
			>
				<Input
					...
					onBlur={handleBlur}
					onClear={handleClear}
					dataHook={dataHooks.inputValueCodeColor}
					{...getInputCodeProps()}
				/>
				...
				{isExpanded && (
					<>
						<Input
							...
							placeholder="Name"
							{...getInputNameProps()}
							dataHook={dataHooks.inputValueNameColor}
							autoFocus
						/>
						<Box gap="12px">
							<Button
			...
			{!isExpanded && group?.editable && (
				<IconButton
					...
					dataHook={dataHooks.actionsAddColorGroup}
				>
					<Tooltip
